...
MIN_DAYS_FOR_INCLUSION = 3.0

# Founders/Investors
DEV_IDS = [490989299911884800, 514672694092890112, 399749457727586304, 574690954380836874]
# Coaches/Mods + Founders/Investors
MASTER_IDS = [490989299911884800, 514672694092890112, 399749457727586304, 574690954380836874, 836432162060107816, 857922053129895957, 838395965647487016]
